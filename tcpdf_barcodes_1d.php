...
class TCPDFBarcode {
	...
	protected function barcode_c128($code, $type='') {
		...
		switch(strtoupper($type)) {
			...
			/**
			* Support for many FNC1 codes in C128C
			* @author Justin Pope <justin@boxc.com>
			* @since 2019-03-29
			* @see https://github.com/bitmash/TCPDF/commit/07ff99b3d79402429cc7f83ea43337712aa1f072
			* Previouly couldn't handle multiple FNC1 values in the code
			* like it should have.
			*/
			case 'C': { // MODE C
				$startid = 105;
